...
public final class SandriosCameraConfiguration {
    ...
    private SandriosCameraConfiguration(Activity activity, int requestCode) {
    ...
    public static class Builder {
        ...
        public Builder(@NonNull Activity activity, @IntRange(from = 0) int requestCode) {
            sandriosCameraConfiguration = new SandriosCameraConfiguration(activity, requestCode);
        }

        public Builder setMediaAction(@MediaAction int mediaAction) {
            sandriosCameraConfiguration.mediaAction = mediaAction;
            return this;
        }

        public Builder setMediaQuality(@MediaQuality int mediaQuality) {
            sandriosCameraConfiguration.mediaQuality = mediaQuality;
            return this;
        }

        public Builder showPicker(boolean showPicker) {
            sandriosCameraConfiguration.showPicker = showPicker;
            return this;
        }
        ...
        public Builder setVideoDuration(@IntRange(from = 1000, to = Integer.MAX_VALUE) int videoDurationInMilliseconds) {
            sandriosCameraConfiguration.videoDuration = videoDurationInMilliseconds;
            return this;
        }
        ...
        public Builder setMinimumVideoDuration(@IntRange(from = 1000, to = Integer.MAX_VALUE) int minimumVideoDurationInMilliseconds) {
            sandriosCameraConfiguration.minimumVideoDuration = minimumVideoDurationInMilliseconds;
            return this;
        }
        ...
        public SandriosCameraConfiguration build() throws IllegalArgumentException {
            if (sandriosCameraConfiguration.requestCode < 0)
                throw new IllegalArgumentException("Wrong request code value. Please set the value > 0.");
            if (sandriosCameraConfiguration.mediaQuality == MEDIA_QUALITY_AUTO && sandriosCameraConfiguration.minimumVideoDuration < 0) {
                throw new IllegalStateException("Please provide minimum video duration in milliseconds to use auto quality.");
            }

            return sandriosCameraConfiguration;
        }
